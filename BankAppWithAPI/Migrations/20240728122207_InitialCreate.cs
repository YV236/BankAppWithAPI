    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BankAccountCards", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BankAccountCards_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BankAccountCards_BankAccounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "BankAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BankAccountCards_Cards_CardId",
                        column: x => x.CardId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BankAccountCards_AccountId",
                table: "BankAccountCards",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_BankAccountCards_CardId",
                table: "BankAccountCards",
                column: "CardId");

            migrationBuilder.CreateIndex(
                name: "IX_BankAccountCards_UserId",
                table: "BankAccountCards",
                column: "UserId");
